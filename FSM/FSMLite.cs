...
namespace UnityLibrary.YesUnity.FSM
{
    public class FSMLite
    {
        ...
        /// Handles the event.
        /// </summary>
        /// <param name="translateName">转换动作名字.</param>
        /// <param name="param">Parameter.</param>
        public void HandleEvent(string translateName, params object[] param)
        {
            if (mCurState != null && mStateDict[mCurState].TranslationDict.ContainsKey(translateName))
            {
                QFSMTranslation tempTranslation = mStateDict[mCurState].TranslationDict[translateName];
